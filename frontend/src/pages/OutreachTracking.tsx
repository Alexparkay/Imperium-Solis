        ...
        <div className="flex flex-col gap-6">
          ...
          {showContacts && (
            <div className="flex flex-col gap-4">
              {/* Filters and search */}
              <div className="backdrop-blur-2xl bg-gradient-to-br from-[#28292b]/80 via-[#28292b]/50 to-[rgba(40,41,43,0.2)] rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-orange-500/15 p-4 relative overflow-hidden">
                <div className="flex flex-wrap gap-3 items-center">
                  <div className="relative">
                    <input 
                      type="text" 
                      placeholder="Search contacts..." 
                      className="input input-sm backdrop-blur-md bg-[#28292b]/60 border border-orange-500/20 text-white focus:border-orange-500 pl-10 w-64"
                    />
                    <MdOutlineEmail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-orange-500" />
                  </div>
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    ...
                    <div className="dropdown dropdown-end">
                      ...
                      <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 backdrop-blur-2xl bg-gradient-to-br from-[#28292b]/90 via-[#28292b]/90 to-[rgba(40,41,43,0.9)] shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-orange-500/15 rounded-box w-40">
              ...
              {/* Contact data table */}
              <div className="backdrop-blur-2xl bg-gradient-to-br from-[#28292b]/80 via-[#28292b]/50 to-[rgba(40,41,43,0.2)] rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-orange-500/15 p-2 relative overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="table table-sm w-full">
                    ...
                    <tbody>
                      {displayContacts.map((contact, index) => (
                        <tr key={index} className="hover:bg-[#28292b]/40 border-b border-orange-500/10">
                ...
                <div className="flex justify-between items-center mt-6 px-2">
                  ...
                  <div className="text-white/60 text-sm">
                    ...
                    <input 
                      ...
                      className="ml-2 input input-xs input-bordered w-14 bg-[#28292b]/60 border-orange-500/30 text-white text-center"
                    />
                  </div>
                </div>
              </div>
