...
const MenuItem: React.FC<MenuItemProps> = ({ item, isActive }) => {
  ...
  const getColorScheme = () => {
    switch (item.colorScheme) {
      ...
      default:
        return {
          active: 'from-orange-500/40 to-amber-500/30',
          hover: 'from-orange-500/5 via-amber-500/3 to-orange-600/5',
    ...
    return (
      ...
      >
        ...
        >
          ...
          {isActive && (
            <div className={`absolute -left-4 top-1/2 transform -translate-y-1/2 w-2 h-8 bg-gradient-to-r ${colors.active} rounded-r-full shadow-[0_0_10px_rgba(249,115,22,0.4)]`} />
          )}
